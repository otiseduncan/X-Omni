...
workflow that records which sources were actually searched. Calibration and
...
same deep ADAS PDF search. Final policy and audit guards keep execution truthful
and fail closed.
"""
