...
REVIEW_SYSTEM_PROMPT = (
    ...
    "otherwise MISSING_OR_UNCERTAIN. If the procedure depends on another document to be "
    "performable -- a prerequisite alignment, a target setup, a separate initialization "
    "-- name it in dependencies with the reason the objective needs it; never list a "
    "cross-reference just because it is linked. Decide: ACCEPT when this page alone "
