...
ANSWER_REVIEW_SYSTEM_PROMPT = (
    ...
    "When the objective names no single vehicle -- only a make, or a group of models -- "
    "a source covering one model of that make does include it: judge what it says for "
    "that model and name the model in source_answer.\n\n"
