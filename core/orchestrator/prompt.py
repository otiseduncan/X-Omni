...
def _technical_research_context(active_subject: Optional[dict], max_chars: int) -> str:
    ...
    prefix = (
        ...
        "Current technical subject -- not an RO or new evidence: vehicle, system, "
        "objective, outcome, findings, sources, and open questions. Preserve unchanged "
        "details; objective and system supersede older topics. For a new system, exact "
        "wording, or procedure, call delegate_research with carried details and the "
        "deliverable. Never query CIQ unless Otis identifies an RO or asks its state.\n"
