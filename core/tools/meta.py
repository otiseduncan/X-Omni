...
QUERY_CIQ_SCHEMA: dict[str, Any] = {
    "description": (
        ...
        "Getting the missing maps or map reports is stage_action sweep_adas_maps. "
...
def stage_action_schema(*, allow_unscoped_creates: bool = False) -> dict[str, Any]:
    return {
        "description": (
            ...
            "call that posts results to this chat and runs its own inventory first; "
            "use it when Otis asks to get missing maps or map reports for a list "
            "or scope, even right after an inventory answer, "
