...
One OAuth consent does both jobs — it proves you're the owner *and* carries the Calendar scopes. There is no second auth system.
...
core\
  ...
  api\
    auth.py            Google OAuth, sole-owner binding
